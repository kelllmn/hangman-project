...
| Актор | Роль |
|-------|------|
| **Игрок** | взаимодействует с интерфейсом, вводит буквы, запрашивает подсказки |
| **Система** | автоматически выбирает вопросы, проверяет ответы, открывает буквы |
...
3. Игрок выбирает сложность вопроса
4. Система отображает случайный вопроса выбранной игроком сложности
5. Игрок вводит ответ
6. Система проверяет ответ: при верном - активируется подсказка → открывается случайная буква
8. Кнопка подсказки блокируется до конца раунда
